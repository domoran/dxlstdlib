...
The latest version of the original doxygen can be obtained at
  http://www.doxygen.org/


This modified binary is released under the GNU-GPL Version 3 (see LICENSE.TXT in main folder)